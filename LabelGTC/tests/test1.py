...
def main(debug=True):
    ...
    g = TreeClass("((((a_A,x_B)0.2,(b_B,e_C)0.2)0.9,y_C)0.2,((i_B,k_A)0.1,((c_C, j_A)0.1,(d_B,(g_C,h_A)0.2)0.8)0.2)0.8)0.2;")

    cst = [TreeClass("y_C;"), TreeClass("((b_B,e_C),(a_A,x_B));"), TreeClass("(c_C,j_A);"), TreeClass("(g_C,h_A);"), TreeClass("d_B;"), TreeClass("(i_B,k_A);")]
